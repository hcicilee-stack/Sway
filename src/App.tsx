...
export default function App() {
  ...
  return (
    <div 
      ref={containerRef}
      id="viewport-main"
      className="fixed inset-0 w-screen h-screen flex flex-col justify-between overflow-hidden bg-[#02040a] font-sans text-slate-100 select-none touch-none animate-fade-in"
